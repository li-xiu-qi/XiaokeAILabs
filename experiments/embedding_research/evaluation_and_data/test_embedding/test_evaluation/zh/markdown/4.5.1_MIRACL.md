...
We provide independent evaluation for popular datasets and benchmarks. Try the following code to run the evaluation, or run the shell script provided in example（`../../examples/evaluation/miracl/eval_miracl.sh`，上游路径） folder.
